...
这个问题的关键可能是边缘计算，数据在用户的设备上本地保存和处理。这对于改善客户对智能家居技术的认知可能至关重要。2019 年 Statista 的一份报告表明，46%的智能家居用户将他们的体验描述为侵扰，而 36%的用户将他们的体验描述为恐惧。边缘计算可以帮助客户在使用智能家居物联网技术时感到更安全。
