...
每个服务都通过自己的抽象来扩展系统域层，以满足特定的业务需求。如果新概念只是局部概念(只有在其有限的上下文中才有意义)，它们将只是系统域层的补充，并将与库的抽象一起存在于代码中。但是，如果一个新引入的概念对整个系统有意义，并将用于系统的其他部分，那么它必须包含在库本身中。无论如何,“本地语言”和“系统语言”的扩展都是建立在定义明确的“通用无处不在的语言”之上的，每个人都可以使用和理解这种语言。
