...
![](img/3752d38b808993f9248a2d36c87646c7.png)
...
在微服务架构中，团队在组件的整个生命周期中都拥有组件的所有权。因此，这些组件被命名为产品。
...
本文的第 2 部分描述了微服务架构中需要遵循的基本最佳实践。我使用了 Krishntha Dinesh 先生的以下播放列表来收集所需的信息。
