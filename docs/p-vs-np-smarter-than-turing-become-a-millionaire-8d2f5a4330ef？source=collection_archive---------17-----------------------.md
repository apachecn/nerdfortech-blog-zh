...
所以，你现在一定已经意识到，每个解决方案都可以分成几个步骤，步骤的数量取决于输入的大小。对于一些算法，复杂度是“n”，对于一些其他算法，复杂度可以是 n^2，或者可以是 n^3，或者可以是 logn 或 n log n 等。所有这些复杂性可以被称为“多项式”。
...
![](img/a96d116c58ecdfb5186bf8740bd04a78.png)
...
现在，如果我们在重新排列后玩同样的游戏，它将与玩井字游戏完全相似。
